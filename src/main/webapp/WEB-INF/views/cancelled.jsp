...
<body>
	...
	<div class="container mt-5">
		...
		<form class="form-inline" action="handleCancel" method="post">
			<div class="form-group">
				<label class="sr-only" for="inlineFormInputName2">Enter Booking ID</label>
				<input type="text" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2"  name="book" placeholder="Booking ID">
				<button type="submit" class="btn btn-primary mb-2">Cancel Booking</button>
			</div>
